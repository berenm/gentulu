...
# $Revision: 15032 $ on $Date: 2011-07-06 02:24:15 -0700 (Wed, 06 Jul 2011) $
...
# EGL_NV_depth_nonlinear
	EGL_DEPTH_ENCODING_NONE_NV			= 0	    # Not an alias for EGL_NONE!
...
# Draft EGL_KHR_create_context (additional; see above)
...
#	EGL_IMAGE_USE_AS_OPENGL_ES1_RENDERBUFFER_KHR	 = 0x31F0

# Draft KHR_image_use_gl1_texture_2d enum:
#	EGL_IMAGE_USE_AS_OPENGL_ES1_TEXTURE_2D_KHR	 = 0x31F1

# Draft KHR_image_use_gl1_texture_external enum:
#	EGL_IMAGE_USE_AS_OPENGL_ES1_TEXTURE_EXTERNAL_KHR = 0x31F2

# Draft KHR_image_use_gl2_renderbuffer enum:
#	EGL_IMAGE_USE_AS_OPENGL_ES2_RENDERBUFFER_KHR	 = 0x31F3

# Draft KHR_image_use_gl2_texture_2d enum:
#	EGL_IMAGE_USE_AS_OPENGL_ES2_TEXTURE_2D_KHR	 = 0x31F4

# Draft KHR_image_use_gl2_texture_external enum:
#	EGL_IMAGE_USE_AS_OPENGL_ES2_TEXTURE_EXTERNAL_KHR = 0x31F5

# Draft KHR_image_use_vg_vgimage enum:
#	EGL_IMAGE_USE_AS_OPENVG_IMAGE_KHR		 = 0x31F6

# EGL_MESA_image_stream_internal enum:
#	EGL_STREAM_CONSUMER_ATTACHMENT_MESA		 = 0x31F7
#	EGL_NO_FORMAT_MESA				 = 0x31F8
#	EGL_FORMAT_RGBA8888_MESA			 = 0x31F9
#	EGL_FORMAT_RGB888_MESA				 = 0x31FA
#	EGL_FORMAT_RGB565_MESA				 = 0x31FB

# Khronos_future_use: 0x31FC-0x31FF
...
# Any_vendor_future_use: 0x3210-0x3FFF
#
